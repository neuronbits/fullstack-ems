        ...
        <div className='animate-fade-in'>
            ...
            <div className='flex flex-col sm:flex-row gap-3 mb-6'>
                <div className='relative flex-1'>
                    ...
                    <input type="text" placeholder='Search employees...' className='pl-10 w-full' value={search} onChange={(e) => setSearch(e.target.value)} />
                </div>
                ...
                <div className='fixed bg-black/40 backdrop-blur-sm inset-0 z-50 flex items-start justify-center p-4 overflow-y-auto' onClick={() => setShowCreateModal(false)}>
                    ...
                    <div className='relative bg-white rounded-2xl shadow-2xl w-full max-w-3xl my-8 animate-fade-in' onClick={(e) => e.stopPropagation()}>
                        <div className='flex items-center justify-between p-6 pb-0'>
                            ...
                            <button onClickCapture={() => setShowCreateModal(false)} className='p-2 rounded-lg hover:bg-slate-100 transition-colors text-slate-400 hover:text-light-600'>
                                <X className="w-5 h-5" />
                            </button>
                        </div>
                        <div className='p-6'>
            ...
            {editEmployee && (
                <div className='fixed inset-0 z-50 flex items-start justify-center p-4 overflow-y-auto bg-black/40 backdrop-blur-sm' onClick={() => setEditEmployee(null)}>
                    <div className='relative bg-white rounded-2xl shadow-2xl w-full max-w-3xl my-8 animate-animate-fade-in' onClick={(e) => e.stopPropagation()}>
                        <div className='flex items-center justify-between p-6 pb-0'>
                            <div>
                            ...
                            <button onClickCapture={() => setEditEmployee(null)} className='p-2 rounded-lg hover:bg-slate-100 transition-colors text-slate-400 hover:text-light-600'>
                                <X className="w-5 h-5" />
                            </button>
                        </div>
                        <div className='p-6'>
