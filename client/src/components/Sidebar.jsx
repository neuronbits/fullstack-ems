...
import { CalendarIcon, ChevronsRightIcon, DollarSignIcon, FileTextIcon, LayoutGridIcon, Loader, LogOutIcon, MenuIcon, SettingsIcon, UserIcon, XIcon } from 'lucide-react';
...
const Sidebar = () => {
    ...
    return (
        <>
            ...
            {/* Sidebar Mobile */}
            <aside className={`lg-hidden fixed inset-y-0 left-0 w-72 lg-linear-to-b from slate-900 via-slate-900 to-slate-950 text-white z-50 flex flex-col transform transition-transform duration-300 ${mobileOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                {sidebarContent}
            </aside >
        </>
    )
